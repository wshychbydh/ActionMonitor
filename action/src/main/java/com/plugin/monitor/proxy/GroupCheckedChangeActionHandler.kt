...
internal class GroupCheckedChangeActionHandler internal constructor(target: RadioGroup.OnCheckedChangeListener) : DefaultActionHandler(target) {
    ...
    override fun doAction(obj: Any, method: Method, args: Array<Any>) {
        ...
        Monitor.onCheckedChanged(args[0] as RadioGroup, args[1] as Int)
    }
}
